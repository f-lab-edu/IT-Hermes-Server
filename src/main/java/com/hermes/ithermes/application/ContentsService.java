...
public class ContentsService {
    ...
    public List<ContentsDtoInterface> getCategoryContents(CategoryType type, int page, OrderType order){
        ...
        if(type.getName().equals("JOB")) {
            return convertEntityToDtoList(jobRepository.findJobBySorting(pageInfo,CategoryType.JOB,order),new ContentsContentsDto());
        }
    ...
    private List<ContentsDtoInterface> pageYoutubeAndNewsConvertMainPageContentsDto(Pageable page, CategoryType category){
