...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .and()
                .authorizeHttpRequests().requestMatchers("/api/youtube-and-news/", "/api/job/","/api/crawling-contents-last-title/","/api/alarm/").permitAll()
                .and()
                .authorizeHttpRequests().requestMatchers("/contents/main","/url-record/","/contents/count").permitAll()
                .and()
                .authorizeHttpRequests().requestMatchers("/api/contents/main","/api/url-record/","/api/contents/count").permitAll()
                .and()
