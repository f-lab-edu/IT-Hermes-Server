...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .and()
                .authorizeHttpRequests().requestMatchers("/api/contents/main","/api/url-record/","/api/contents/count","/api/contents/search","/api/contents/refreshCache","/api/contents/elasticsearch","/api/subscribe/elasticsearch").permitAll()
                .and()
